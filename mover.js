let mover = {
    ...
    /**
     * Функция проверки предела поля
     * @param nextPosition следующая позиция игрока не должна превышать заданных настроек в config.js
     * @returns {boolean} возвращает true если следующая позиция не выхдит за пределы поля, false если выходит
     */
    canPosition(nextPosition) {
